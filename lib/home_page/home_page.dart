...
import 'package:doc_scanner/home_page/search_delegate.dart';
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Row(
                mainAxisAlignment:size.width >= 600? MainAxisAlignment.spaceAround: MainAxisAlignment.spaceBetween,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final qrCode = homePageProvider.barCodeFiles[index];
                        return GestureDetector(
                          onTap: () async {
                            showQrAndBarCodeViewDialogue(
                                context: context, text: qrCode);
